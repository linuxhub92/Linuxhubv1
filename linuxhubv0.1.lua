loadstring(game:HttpGet("https://raw.githubusercontent.com/linuxhub92/Linuxhub/main/linuxhubv0.1.lua"))()

local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/linuxhub92/Linuxhub/main/linuxhubv0.1.lua"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Menu Farm", Icon = "home" }),
    Setting = Window:AddTab({ Title = "Cài Đặt Farm", Icon = "settings" }),
    Stats = Window:AddTab({ Title = "Cộng Chỉ Số", Icon = "plus-circle" }),
    ...
    Shop = Window:AddTab({ Title = "Mua Item", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Điều Khoản Khác", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Sever Hop", Icon = "wifi" }),
}
